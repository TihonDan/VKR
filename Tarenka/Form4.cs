...
namespace Tarenka
{
    public partial class Form4 : Form
    {
        ...
        public void deleteRecord(int id)
        {
            if (selectGrid != null)
            {
                ...
                try
                {
                    ...
                    NpgsqlCommand command = new NpgsqlCommand("delete from staff where id = :id", connection);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            selectGrid1 = dataGridView1.SelectedRows[0].Cells["Фамилия"].Value.ToString();
            selectGrid2 = dataGridView1.SelectedRows[0].Cells["Имя"].Value.ToString();
            selectGrid3 = dataGridView1.SelectedRows[0].Cells["Отчество"].Value.ToString();
        ...
        private void materialButton4_Click(object sender, EventArgs e)
        {
            if (selectGrid != null)
            {
                Update_gruppy update_gruppy = new Update_gruppy(selectGrid1, selectGrid2, selectGrid3, selectGrid4, Convert.ToInt32(selectGrid));
